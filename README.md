...
| File | What it covers |
|---|---|
| `01-project-overview.md` | What the product is, goals, and high-level concepts |
| `02-tech-stack.md` | Every library and tool used and why |
| `03-monorepo-structure.md` | Full folder structure with explanations |
| `04-shared-packages.md` | @workflow/types, @workflow/validators, @workflow/node-definitions |
| `05-database-schema.md` | All Postgres tables, columns, RLS policies |
| `06-authentication.md` | How auth works end to end |
| `07-workflow-engine.md` | How workflows are executed node by node |
| `08-node-system.md` | How nodes are defined and how to add new ones |
| `09-credential-management.md` | How secrets are encrypted and used |
| `10-realtime-streaming.md` | How live execution logs are pushed to the frontend |
| `11-frontend-architecture.md` | Pages, state, data fetching, component responsibilities |
| `12-edge-functions.md` | All Supabase Edge Functions explained |
| `13-job-scheduling.md` | How cron-triggered workflows are scheduled |
| `14-environment-variables.md` | All env vars for frontend and edge functions |
| `15-local-development.md` | How to run the project locally |
| `16-architectural-decisions.md` | Why we made the key technical choices we did |
